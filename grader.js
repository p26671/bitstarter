...
var checkHtmlFile = function(htmlfile, checksfile, urllocation) {
    if (urllocation) {
        $ = cheerio.load(urlResponse);
    }
    else {
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url_string>', 'URL Path to index.html', clone(assertUrlExists))
        .parse(process.argv);
    if (! program.url) {
        processData();
    }
